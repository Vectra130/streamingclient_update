...
if( $updateCheck[0] != "" )
{
    echo '<p><b>Neues Online Update gefunden.</br></br>Aktuelle Version:&nbsp;&nbsp;&nbsp;&nbsp;<font color=blue>v'.exec('cat /etc/vectra130/VERSION').'</font></br></br>Update Version:&nbsp;&nbsp;&nbsp;&nbsp;<font color=blue>v'.$updateCheck[0].'</font></br>Gr&ouml;&szlig;e:&nbsp;&nbsp;&nbsp;&nbsp;<font color=blue>'.$updateCheck[2].'</font></br>Datum:&nbsp;&nbsp;&nbsp;&nbsp;<font color=blue>'.$updateCheck[1].'</font></br></br></p>';
